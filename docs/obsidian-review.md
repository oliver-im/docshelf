...
| Custom webview creation | Obsidian's typed creation helper does not include Electron's webview element. A single documented exception creates it in the owning view's document; the private session, sandbox, and navigation guard remain in place. |
